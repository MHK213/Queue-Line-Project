// A static version -> operates on an external string.
// A non-static version -> operates on _Value.
// IsVowel and InvertLetterCase have just static versions -> operate on an external character since the object is a string
